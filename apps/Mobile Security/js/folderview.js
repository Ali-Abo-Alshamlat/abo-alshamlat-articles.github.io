...
function openLocation(thelocation){
    ...
    if(thelocation=="Android101") aboutLocation=["Android101.html","/home/user/Android101",1];
    if(thelocation=="LOTR Hero Mania") aboutLocation=["LOTR Hero Mania.html","/home/user/LOTR Hero Mania",2];
    if(thelocation=="Mobile App") aboutLocation=["Mobile App.html","/home/user/Mobile App",3];
    if(thelocation=="Other Locations") aboutLocation=["other_locations.html","Other Locations",4];
