...
function openLocation(thelocation){
    ...
    if(thelocation=="Invincible") aboutLocation=["Invincible.html","/home/user/Invincible",1];
    if(thelocation=="Missing Person") aboutLocation=["Missing Person.html","/home/user/Missing Person",2];
    if(thelocation=="Other Locations") aboutLocation=["other_locations.html","Other Locations",3];
