...
function openLocation(thelocation){
    ...
    if(thelocation=="Arp Storm") aboutLocation=["Arp Storm.html","/home/user/Arp Storm",1];
    if(thelocation=="Hidden in Plain") aboutLocation=["Hidden in Plain.html","/home/user/Hidden in Plain",2];
